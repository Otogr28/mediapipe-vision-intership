...
`].filter(es).join(`
`)),o=kl(o),o=Fu(o,t),o=Bu(o,t),a=kl(a),a=Fu(a,t),a=Bu(a,t),o=Vu(o),a=Vu(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+m);const b=T+p+o,M=T+m+a,E=Du(r,r.VERTEX_SHADER,b),y=Du(r,r.FRAGMENT_SHADER,M);r.attachShader(v,E),r.attachShader(v,y),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function R(P){if(i.debug.checkShaderErrors){const I=r.getProgramInfoLog(v)||"",W=r.getShaderInfoLog(E)||"",q=r.getShaderInfoLog(y)||"",F=I.trim(),G=W.trim(),k=q.trim();let $=!0,j=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,E,y);else{const te=Ou(r,E,"vertex"),he=Ou(r,y,"fragment");Ne("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
